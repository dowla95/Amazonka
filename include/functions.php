...
function rotiraj($slika, $orijentacija, $slika_new="") {
if($slika_new=="") $slika_new=$slika;
$sl_expl=explode(".",$slika);
$ext=end($sl_expl);


if($ext == "jpeg" || $ext == "jpg")
$imageObject = imagecreatefromjpeg($slika);
else
if($ext == "x-png" || $ext == "png")
$imageObject = imagecreatefrompng($slika);
else
if($ext == "gif")
$imageObject = imagecreatefromgif($slika);
if($orijentacija=='r')
...
if($ext == "jpeg" || $ext == "jpg")
imagejpeg($imageObject, $slika_new, 90);
else
if($ext == "gif")
imagegif($imageObject, $slika_new, 90);
else
if($ext == "x-png" || $ext == "png")
imagepng($imageObject, $slika_new, 5);
}
...
{
?>
<ul  class='ul divu <?php echo $boja ?>' id="polje<?php echo $ul?>">
<?php 
...
echo "<li $prik><label style='display:block'><input type='checkbox' name='include_".$col."[]' value='$entry' /> $entry</label></li>";
}
}
}
closedir($handle);
