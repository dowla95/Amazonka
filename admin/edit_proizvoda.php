...
if($zz1['novo']==1) $novic="checked"; else $novic="";
if($zz1['izdvojeni']==1) $izdi="checked"; else $izdi="";
...
&nbsp; &nbsp;<label><b>3. <?php echo $arrwords['karakteristika2']?></b> <input type="radio" value='1' name='novo' <?php echo $novic?> /></label>
&nbsp; &nbsp;<label><b>4. <?php echo $arrwords['karakteristika3']?></b> <input type="radio" value='0' name='novo' <?php echo $izdi?> /></label>
