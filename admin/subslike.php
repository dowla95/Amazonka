...
elseif($_GET['tip']==2)
{
$velicina="Poželjno je da sve slike u slider-u budu istih dimenzija. Preporučena veličina ovih slika je 1600x480px.";
?>
...
- Favicon: 32x32px<br>
- 1 reklamni baner: 1600x200px<br>
- 2 reklamna banera: 825x200px<br>
- 3 reklamna banera: 540x200px";
$id_page=0;
?>
