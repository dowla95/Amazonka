...
$tz = mysqli_query($conn, "SELECT p.*, pt.*, p.id as ide
  ...
  if($tz1['ide']==3) $no=" d-none"; else $no="";
                      ?>
...
<a href="javascript:;" style='position:relative;left:10px;' onclick="geti()">SAČUVAJ STAVKE MENIJA</a>
...
$im1=mysqli_fetch_assoc($im);        
    ...
    <li class='route' id="<?php echo $tz1['id']?>">
      <h3 class='title' id='title1'><?php echo $im1["naziv"]?> <?php echo $tz1['id']?></h3>
      <span class='ui-icon ui-icon-arrow-4-diag'></span>
      <ul class='space' id='space2'>
      <?php 
...
$ima1=mysqli_fetch_assoc($ima);     
      ?>
       <li class='route' id="<?php echo $hz1['id']?>">
          <h3 class='title' id='title3'><?php echo $ima1["naziv"]?> <?php echo $hz1['id']?></h3>
          <span class='ui-icon ui-icon-arrow-4-diag'></span>
          <ul class='space' id='space3'>
...
$imaz1=mysqli_fetch_assoc($imaz);  
      ?>
       <li class='route' id="<?php echo $pz1['id']?>">
          <h3 class='title' id='title3'><?php echo $imaz1["naziv"]?> <?php echo $pz1['id']?></h3>
          <span class='ui-icon ui-icon-arrow-4-diag'></span>
          <ul class='space' id='space4'>
