...
$u=mysqli_query($conn, "SELECT subtip FROM $_POST[tabli]  WHERE id=$id");
$u1=mysqli_fetch_assoc($u);

if(isset($_POST['subtip']) and $_POST['subtip']!='') {
...
if($pi==$ep[1]) {
echo "Vec ste dodali maksimalan broj slika tipa ".$nizSub[$_POST['subtip']];
exit();
}
$subtip=", subtip=".$ep[0];
}
} else
$subtip=", subtip=".$_POST['subtip'];
} else $subtip="";
