...
<td>
<a href="index.php?base=admin&page=stavke&id=<?php echo $og1['id']?>" class="olovcica"><i class="fas fa-pencil-alt"></i></a>&nbsp;&nbsp;
<a href="javascript:;" class="crvena" onclick="obrisime(<?php echo $og1['id']?>,'delete_stavke')"><i class="fal fa-trash-alt"></i></a>
</td>
</tr>
<?php 
$i++;
