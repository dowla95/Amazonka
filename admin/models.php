...
<td>
<a href="index.php?base=admin&page=models&id=<?php echo $og1['id']?>" class="edit_oglas"><img src="<?php echo $patHA?>/images/b_edit.png" /></a>&nbsp;&nbsp;
<a href="javascript:;" class="edit_oglas" onclick="obrisime(<?php echo $og1['id']?>,'delete_models')"><img src="<?php echo $patHA?>/images/b_drop.png" /></a>
</td>
</tr>
<?php 
$i++;
