...
<a href="<?php echo $patHA?>/index.php?base=admin&page=stavke_add&id=<?php echo $tz1['ide']?>&id_cat=<?php echo $_GET['id_cat']?>"><?php echo $tz1['naziv']." ".$tz1['ide']?></a> &nbsp; &nbsp;
...
<a href="<?php echo $patHA?>/index.php?base=admin&page=stavke_add&id=<?php echo $hz1['ide']?>&id_cat=<?php echo $_GET['id_cat']?>" <?php echo $selet?> style="color:red;"><?php echo $hz1["naziv"]." ".$hz1['ide']?>
...
<a class="olovcica" href="<?php echo $patHA?>/index.php?base=admin&page=stavke_add&id=<?php echo $ahz1['ide']?>&id_cat=<?php echo $_GET['id_cat']?>" <?php echo $selete?>><?php echo $ahz1["naziv"]." ".$ahz1['ide']?>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fas fa-pencil-alt"></i></a>&nbsp; &nbsp;
