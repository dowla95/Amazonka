...
<br>
Vaša <a href='https://amazonka.rs/'>Amazonka</a>
";
$from_name="Amazonka";
...
$fx1=mysqli_fetch_assoc($fax);
if($_POST['ime']=="" or $_POST['email']=="" or $_POST['password']=="" or $_POST['password1']=="" or $_POST['grad']=="" or $_POST['ulica_broj']=="")
$msgr=$arrwords['niste_ispunili'];
else
if($_POST["password"]!=$_POST["password1"])
{
...
$randi=gen_rand();
if(!mysqli_query($conn, "INSERT INTO users_data SET  ime=".safe($_POST['ime']).", email=".safe($_POST['email']).", pib=".safe($_POST['pib']).", akt='Y', password=".safe($password_crypted).", telefon=".safe($_POST['telefon']).", grad=".safe($_POST['grad']).", ulica_broj=".safe($_POST['ulica_broj']).", datum='".date("Y-m-d")."', vesti='$ivesti', randkod='$randi'")) echo mysqli_error();
...
if($_POST['ime']=="" or $_POST['email']=="" or $_POST['grad']=="" or $_POST['ulica_broj']=="")
$msgr=$arrwords['niste_ispunili'];
else
if($_POST["password"]!=$_POST["password1"])
{
...
//$br1=md5(md5(strip_tags($_POST['password']).time()));
 if(isset($_POST['vesti']) and $_POST['vesti']>0) $ivesti=1; else $ivesti=0;
if(!mysqli_query($conn, "UPDATE users_data SET  firma=$firma, provizija=".safe($_POST['provizija']).", tr=".safe($_POST['racun']).", ime=".safe($_POST['ime']).$nazivfirme.", email=".safe($_POST['email']).", avatar='$avatar'$pib, telefon=".safe($_POST['telefon']).", grad=".safe($_POST['grad']).", ulica_broj=".safe($_POST['ulica_broj']).", datum='".date("Y-m-d")."', vesti='$ivesti'$novi_pass WHERE user_id=".$_POST['change_cand']."")) echo mysqli_error();
...
$msr="Potrebno je da upišete 'Naziv u linku'!";
else
{
$i=0;
$tips=$_POST['tips']; 
...
if($_POST['trecina']==1) {$trecina=1; $esnos=0; $sld=0; $polpol=0;} else $trecina=0;
$nazivisa ="id_page='$_POST[id_page]', slika='$slika', video='$video', $pozicija,  time='".time()."', akt='N', youtube=".safe($_POST['youtube']).", youtube_prikaz=".safe($youtubep).", full_img_width='$esnos', mini_slider='$sld', polapola='$polpol', trecina=$trecina, link=".safe($_POST['link'])."";
...
$nazivisa ="id_page='$_POST[id_page]', slika='$slika', video='$video', $pozicija, akt='Y', youtube=".safe($_POST['youtube']).", youtube_prikaz=".safe($youtubep).", full_img_width='$esnos', mini_slider='$sld', polapola='$polpol', trecina=$trecina, link=".safe($_POST['link'])."";
...
if($_POST['novo']==1) $novic="novo=1, izdvojeni=0"; else $novic="novo=0, izdvojeni=1";
