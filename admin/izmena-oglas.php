...
?>
<li><a href='<?php echo $patHA?>/index.php?base=admin&page=izmena-oglas&id=<?php echo $_GET[id]?>&korak=<?php echo $i?>' <?php echo ${"tren$i"}?>><span><?php echo $korak?> - korak <?php echo $i?></span></a></li>
<?php 
}
?>
...
<input type="hidden" name="idoglasa" value="<?php echo $ai1[id_page]?>" /> 
	<table   cellspacing='4' style='float:left;width:96%;'>
    <tr>
			<td class="cck_label" style='width:300px;'>Adresa (ulica i br) srb</td>
      <td class="cck_field">
			<input class="text input_poljes_sivo" type="text"  name="adresaslo"  style='width:350px;' size="32" value="<?php echo htmlspecialchars($_POST[adresaslo]?$_POST[adresaslo]:$ai1[adresaslo], ENT_QUOTES)?>"  />	
       
      	</td>
        	<td class="cck_label" align="right">Adresa (ulica i br) eng </td>
      <td class="cck_field">
			<input class="text input_poljes_sivo" type="text"  name="adresaeng"  style='width:350px;' size="32" value="<?php echo htmlspecialchars($_POST[adresaeng]?$_POST[adresaeng]:$ai1[adresaeng], ENT_QUOTES)?>"  />	
       
      	</td>
		</tr>   
  <tr>
			<td class="cck_label" style='width:300px;'>Minimalna cena</td>
      <td class="cck_field">
			<input class="text input_poljes_sivo" type="text"  name="cena"  style='width:100px;' size="32" value="<?php echo htmlspecialchars($_POST[cena]?$_POST[cena]:$ai1[cena], ENT_QUOTES)?>"  />	
       
      	</td>
        	<td class="cck_label" align="right">Maximalna cena </td>
      <td class="cck_field">
			<input class="text input_poljes_sivo" type="text"  name="cenado"   style='width:100px;' size="32" value="<?php echo htmlspecialchars($_POST[cenado]?$_POST[cenado]:$ai1[cenado], ENT_QUOTES)?>"  />	
 ...
 <tr>
      ...
      <td class="cck_field">
        	...
        	<td class="cck_label" align="right">Za koliko osoba </td>
      <td class="cck_field">
        	...
        	<td class="cck_label" align="right">Br parking mesta </td>
      <td class="cck_field">
			<input class="text input_poljes_sivo" type="text"  name="pm"   style='width:100px;' size="32" value="<?php echo htmlspecialchars($_POST[pm]?$_POST[pm]:$ai1[pm], ENT_QUOTES)?>"  />	
    ...
    <!--   <td>
      ...
      <tr>
			<td class="cck_label">Google maps code (ili iframe):</td>
      <td class="cck_field"  colspan="3">
      <table style='width:100%;' cellspacing="0" cellpadding="0">
      <tr>
      <td>
		<input class="text input_poljes_sivo" type="text"  name="mapa"   size="32" value="<?php echo htmlspecialchars($_POST[mapa]?$_POST[mapa]:$ai1[mapa], ENT_QUOTES)?>"  />	
       </td>
	...
	<tr>
		<td colspan="4" style='padding-top:10px;'><b style="color:#218FBF;font-size:14px;text-transform:uppercase;">Skraceni opis smeštaja SRB</b>  
    <span style='color:red;font-size:18px;'>*</span> 
     
		
                          
               
			<textarea  class="mceEditor"   name="tekst1slo"  cols="25" rows="33" style="height:300px;width:99%;"><?php echo $_POST[tekst1slo]?$_POST[tekst1slo]:$ai1[tekst1slo]?></textarea></td>
      </tr>    
	<tr>
		<td colspan="4" style='padding-top:10px;'><b style="color:#218FBF;font-size:14px;text-transform:uppercase;">Opis  smeštaja SRB</b>  
    <span style='color:red;font-size:18px;'>*</span> 
     
		
                          
               
			<textarea  class="mceEditor"   name="tekstslo"  cols="25" rows="33" style="height:300px;width:99%;"><?php echo $_POST[tekstslo]?$_POST[tekstslo]:$ai1[tekstslo]?></textarea></td>
      </tr>
  	<tr>
		<td colspan="4" style='padding-top:10px;'><b style="color:#218FBF;font-size:14px;text-transform:uppercase;">Skraceni opis smeštaja ENG</b>  
    <span style='color:red;font-size:18px;'>*</span> 
     
		
                          
               
			<textarea  class="mceEditor"   name="tekst1eng" cols="25" rows="33" style="height:300px;width:99%;"><?php echo $_POST[tekst1eng]?$_POST[tekst1eng]:$ai1[tekst1eng]?></textarea></td>
      </tr>        
	<tr>
		<td colspan="4" style='padding-top:10px;'><b style="color:#218FBF;font-size:14px;text-transform:uppercase;">Opis  smeštaja ENG</b>  
    <span style='color:red;font-size:18px;'>*</span> 
     
		
                          
               
			<textarea  class="mceEditor"   name="teksteng" cols="25" rows="33" style="height:300px;width:99%;"><?php echo $_POST[teksteng]?$_POST[teksteng]:$ai1[teksteng]?></textarea></td>
      </tr>
...
<input type="hidden" name="idoglasa" value="<?php echo $_GET[id]?>" />
	<table   cellspacing='4' style='float:left;width:96%;'>

 <tr><td colspan="4">
 <br />
 <b style="color:#218FBF;font-size:14px;text-transform:uppercase;">Tip smeštaja:</b> 
 <br />
...
{
// $ah=mysqli_query($conn, "SELECT * FROM oglas_number_rooms WHERE ido=$_GET[id] AND niz_id=$sad1[id]");
 //$ah1=mysqli_fetch_assoc($ah);
 $aht=mysqli_query($conn, "SELECT * FROM oglasi WHERE id_page=$_GET[id]");
 $aht1=mysqli_fetch_assoc($aht);
 if($aht1['tipsm']==$sad1['id'])
 $iche="checked"; else $iche="";
 ...
 echo "<div style='font-size:11px;float:left;width:33%;'><input type='radio'     id='sadrzz$sad1[id]'  name='tipsm' value='$sad1[id]' $iche /> <label  for='sadrzz$sad1[id]'>$sad1[nazivslo]</label></div>";
 }
 ?>
 </ul>
 </td></tr>
...
if($pros>0) $toje="checked"; else $toje="";*/
 ...
 if($aht1['lokacija']==$sad1['id'])
 $iche1="checked"; else $iche1=""; 
//echo "<div style='font-size:11px;float:left;width:33%;'><input type='radio' name=sadrzaj[] value='$sad1[id]' id='sadrz$sad1[id]' $toje /> <label  for='sadrz$sad1[id]'>$sad1[nazivslo]</label></div>";
echo "<div style='font-size:11px;float:left;width:33%;'><input type='radio' name='lokacija' value='$sad1[id]' $iche1 id='sadrz$sad1[id]' $toje /> <label  for='sadrz$sad1[id]' >$sad1[nazivslo]</label></div>";
}
?>
...
while($sad1=mysqli_fetch_assoc($sad))
{
$pros=mysqli_num_rows(mysqli_query($conn, "SELECT * FROM content_oglas WHERE ido=$_GET[id] AND ids=$sad1[id]"));
if($pros>0) $toje="checked"; else $toje=""; 
...
<tr>
 <td>
<a href="<?php echo $patHA?>/index.php?base=admin&page=izmena-oglas&id=<?php echo $_GET[id]?>&korak=2"><span>&laquo; Prethodni korak</span></a>
 </td>
<td>
...
<tr>
  ...
  <input class="text west input_poljes_sivo" type="text"  name="cenado" placeholder="max cena"   value="<?php echo $_POST[cenado]?$_POST[cenado]:$ai1[cenado]?>" />
	...
	<tr>
		<td colspan="4" style='padding-top:10px;'><b style="color:#218FBF;font-size:14px;text-transform:uppercase;">Detaljni cenovnik</b>  <span style='color:red;'>(Linkovi do vaseg sajta trenutno nisu dozvoljeni)</span> 
   ...
   <!--   
      <tr>
		<td colspan="4" style='padding-top:10px;'><b style="color:#218FBF;font-size:14px;text-transform:uppercase;">Detaljni cenovnik na ENG jeziku</b>   
...
<tr>
 <td>
 <a href="<?php echo $patHA?>/index.php?base=admin&page=izmena-oglas&id=<?php echo $_GET[id]?>&korak=3"><span>&laquo; Prethodni korak</span></a>
 </td>
<td>
...
<br /><br />
<form id="imageform" method="post" enctype="multipart/form-data" action='<?php echo $patHA?>/ajaximage_pages.php?ide=<?php echo $_GET[id]?>&tip=1&tabela=slike_paintb'>
...
<?php 
$das=mysqli_query($conn, "SELECT * FROM slike_paintb WHERE idupisa=$_GET[id] AND tip=1 ORDER BY id DESC");
...
<tr>
 <td>
 <a href="<?php echo $patHA?>/index.php?base=admin&page=izmena-oglas&id=<?php echo $_GET[id]?>&korak=4"><span>&laquo; Prethodni korak</span></a>
 </td>
