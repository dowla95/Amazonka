...
<div class='naslov_smestaj'><h1>Upisani tekstovi za stranicu i podstranice <span style='color:#444;'><?php echo $ova1["naziv$amlang"]?></b></h1></div>
 ...
 <td align='right'><a href="<?php echo $patHA?>/index.php?base=admin&page=page_add_content&tip=id_page&idp=<?php echo $_GET['idp']?>"><span style='padding:6px 0px;font-size:15px;'>UPIŠI NOVI TEKST</span></a>
...
$fi=mysqli_query($conn, "SELECT * FROM pages_text WHERE $andidpS id>0 $plun ORDER BY  $orderby LIMIT $str,$ByPage1");
?>
