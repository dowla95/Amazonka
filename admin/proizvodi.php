...
<div class='naslov_smestaj'><h1>UPISANI PROIZVODI (<a href='export-xls.php'>exel</a>)<span style='color:#444;'><?php echo $ova1["naziv$amlang"]?></h1></div>
 ...
 <td align='right'><a href="<?php echo $patHA?>/index.php?base=admin&page=add_proizvoda&tip=<?php echo $_GET['tip']?>"><span style='padding:6px 10px;font-size:15px;'>UPIŠI NOVI PROIZVOD</span></a>
