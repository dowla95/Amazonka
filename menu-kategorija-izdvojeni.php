<div class="categories-menu-bar mr-20">
...
?>
<li><a href="<?php echo $ulinka?>" title="<?php echo $me1['naziv']?>"><?php echo $me1['naziv'].$strdesno?></a>
<?php
$pros = mysqli_query($conn,"SELECT slika FROM page WHERE id=3");
$pros1 = mysqli_fetch_assoc($pros);
if($benuArrp[$me1['ide']] && count($benuArrp[$me1['ide']])>0){
if($me1['mega_menu']==1) {
$ecc=" class='cat-submenu category-mega row ml-0'";
$ecc1=" class='cat-mega-title'";
$ecc2="";
}
else {
$ecc2=$ecc=" class='cat-submenu'";
$ecc1="";
}
?>
<ul<?php echo $ecc?>>
...
if($ze1['slika']!="" and $me1['mega_menu']==1) $slikkat="<img class='d-none d-lg-block d-xl-block float-left' src='".$patH."/".GALFOLDER."/".$ze1['slika']."' alt='".$ze1['naziv']."' title='".$ze1['naziv']."'>"; else $slikkat="";
...
<?php echo $slikkat.$ze1['naziv']." ".$strdesno1?></a><?php echo $li?>
<?php
...
{
if($ne1['slika']!="" and $me1['mega_menu']==1) $slikkat2="<img class='d-none d-lg-block d-xl-block float-left katimg' src='".$patH."/".GALFOLDER."/".$ne1['slika']."' alt='".$ne1['naziv']."' title='".$ne1['naziv']."'>"; else $slikkat2="";
