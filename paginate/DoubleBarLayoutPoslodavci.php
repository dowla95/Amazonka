...
class DoubleBarLayout implements PageLayout {
	...
	public function fetchPagedLinks($parent, $queryVars) {
		...
		if(!$parent->isFirstPage()) {
			...
			$str .= "<li class='page_prev'><a href=\"$queryVars$previousPage\"  ><i class='fa fa-angle-double-left'></i></a></li>";
		}
	...
	$str .= "<li class='page_num'><a href=\"$queryVars$i\"   >$i </a></li>";
		...
		if(!$parent->isLastPage()) {
			...
			$str .= "<li class='page_next'><a href=\"$queryVars$nextPage\"   ><i class='fa fa-angle-double-right'></i></a></li>";
		}
		return $str;
	}
}
