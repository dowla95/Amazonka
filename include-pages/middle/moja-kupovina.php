...
WHERE p.tip=5 AND p.akt=1 AND po.kupac=$_SESSION[userid] AND p.prodato=0 ORDER BY pd.vreme DESC");
?>
...
?>
 ...
 ?>
			...
			<div class="col-md-7">
				<p>
				<b>Porudžbina broj: <?php echo $fif1['id_porudzbine']?></b><br>
				<b>Od prodavca <?php echo $prodavac['nickname']."</b>, ".$vreme?>, naručio sam <?php echo $alink.$fif1['naslov'].$nealink?><br>
