<?php 
if($settingsc['poz_k5']!="") $pozboja=" style='background:".$settingsc['poz_k5']."'"; else $pozboja="";
if($settingsc['limit_k5']<1) $lim="LIMIT 7"; else $lim="LIMIT ".$settingsc['limit_k5'];
$ztz = mysqli_query($conn, "SELECT p.*, pt.*, p.id as ide
        FROM pro p
        INNER JOIN prol pt ON p.id = pt.id_text
        WHERE pt.lang='$lang' AND p.akt=1 AND p.vegan=1 AND p.prodato=0 AND lager=1 ORDER BY p.pozicija, rand() $lim");
    ...
    <div class="home-module-three hm-1 fix pb-40"<?php echo $pozboja?>>
        <div class="container-fluid">
            <div class="section-title module-three">
                <h3><?php echo $arrwords['karakteristika5']?></h3>
            </div>
...
while($atz1=mysqli_fetch_array($ztz))
 ...
 ?>
 								<div class="col mb-30" data-aos='fade-right' data-aos-duration='300'>
...
<?php } ?>
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <div class="product-name">
												<h4><a href="<?php echo $patH1?>/<?php echo $all_links[3]?>/<?php echo $plusi?><?php echo $atz1['ulink']?>-<?php echo $atz1['ide']?>/" title="<?php echo $atz1['naslov']?>"><?php echo $atz1['naslov'].$a2['brend']?></a></h4>
                                            </div>
                                            <div class="ratings">
<?php
$ocena=0;
