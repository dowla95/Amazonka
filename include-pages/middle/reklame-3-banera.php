<?php
$reks = mysqli_query($conn, "SELECT * FROM slike, slike_lang WHERE slike.id=slike_lang.id_slike AND slike.akt='Y' AND slike.tip=3 AND slike.subtip=4 ORDER BY pozicija, rand()");
?>
...
?>
                <div class="col-lg-4 col-md-4 mt-20 mb-20">
