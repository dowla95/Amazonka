            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="breadcrumb-wrap">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?=$patH?>">Naslovna</a></li>
<?php if($base_arr_r[0]==$sodom_ex[0]) echo "<li class='breadcrumb-item'>Blog</li>"; else {
...
?>
							...
							<li class="breadcrumb-item active"><?=$ptnja1['naslov']?></li>
<?php } ?>
                        </ul>
						</nav>
                    </div>
...
<?php include('include/slidebar-left-blog.php');?>
...
<?php echo "<a class='theme-button mt-30 float-right' href='".$patH1."/".$page1["ulink"]."/".$pte1["ulink"]."/'>".$arrwords['detaljniije_link']."</a>";?>
                                            </div>
                                        </div>
                                    </div>
									<hr>
...
<?php
if($pate1["naslov"]!="")
echo "<h3 class='post-title'>".$pate1["naslov"]."</h3>";
?>                        
...
if(mysqli_num_rows($pp)>0 and $pate1['mini_slider']==1) $galcl="blog-thumb-active owl-carousel"; else $galcl="single-blogg-item mb-30";
if(isset($pate1['slika']) and $pate1['slika']!="") { ?>
                                <div class="<?php echo $galcl.$pola?>">
                                    <div class="blog-thumb blog--hover">
<img src="<?=$patH?><?php echo GALFOLDER ?>/<?php echo $pate1['slika']?>" alt="<?php echo $pate1["altslike"]?>" title="<?php echo $pate1["titleslike"]?>" class="img-fluid">
                                    </div>
...
<?php if($pate1['keywords']!="") { ?>
						<button class="theme-button mt-20 float-right" onclick="window.location.href='<?php echo $pate1['keywords']?>'"><?php echo $arrwords['mozda_vas_zanima']?> <i class="fal fa-arrow-alt-right"></i></button>
<?php } ?>
						<button class="theme-button mt-20 float-left" onclick="window.history.go(-1); return false;"><i class="fal fa-arrow-alt-left"> <?php echo $arrwords['nazad']?></i></button>
						</div>
...
<h4>Ukoliko Vam se sviđa ovaj tekst, podelite ga sa drugima:</h4>
<script src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-544e63824678ceec"></script>
...
?>
	<div class="related-post-container container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="related-post-title mb-10">POVEZANI POSTOVI</h3>
			</div>
		</div>
        <div class="row">
<?php
                ...
                <div class="single-related-post">
                    ...
                    <div class="content">
                        <h3 class="related-post-title"> 
                            <a href='<?=$patH1?>/<?=$page1["ulink"]?>/<?=$izg2["ulink"]?>/'><?=$izg2['naslov']?></a>
						</h3>
							<p><?php echo substr(strip_tags($izg2["opis"]),0,80)?>...</p>					
						<p>
						<span><i class="fal fa-clock"></i> <?php echo date("H:i",$izg2['time'])?></span>
						<span class="separator">|</span>
						<span><i class="fal fa-calendar-alt"></i> <?php echo datum(date("Y-m-d",$izg2['time']))?></span>
						</p>
                    </div>
                </div>
            </div>
