...
$mlista .='
                        <div class="col mb-30">
                            <div class="product-item">
								<div class="product-thumb">
                                    <a href="'.$patH1.'/'.$zalink.'/'.$az1['ulink'].'-'.$az1['id'].'/" title="'.$az1['naslov'].'">
...
$mlista .='
                                    ...
                                    <div class="action-links">
                                        <a href="'.$patH1.'/'.$zalink.'/'.$az1['ulink'].'-'.$az1['id'].'/" title="'.$az1['naslov'].'"><i class="fal fa-eye"></i></a>
';
...
$mlista .='
								...
								<div class="product-caption">
									<div class="product-name">
										<h4><a href="'.$patH1.'/'.$zalink.'/'.$az1['ulink'].'-'.$az1['id'].'/" title="'.$az1['naslov'].'">'.$az1['naslov'].'</a></h4>
									</div>
									<div class="price-box">
';
if($az1['cena']!=0) {
