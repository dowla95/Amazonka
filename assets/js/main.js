	...
	"use strict";
		...
		$('[data-countdown]').each(function() {
			...
			$this.countdown(finalDate, function(event) {
				$this.html(event.strftime('<div class="single-countdown"><span class="single-countdown__time mr-1">%D</span><span class="single-countdown__text">Dan</span></div><div class="single-countdown"><span class="single-countdown__time mr-1">%H</span><span class="single-countdown__text">Sat</span></div><div class="single-countdown"><span class="single-countdown__time mr-1">%M</span><span class="single-countdown__text">Min</span></div><div class="single-countdown"><span class="single-countdown__time">%S</span><span class="single-countdown__text">Sec</span></div>'));
			});
		});
