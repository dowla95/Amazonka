(function ($) {
 ...
 /*=============================================
	...
	mainMenuNav.meanmenu({
		...
		meanMenuClose: '<span class="mean-menu-text"><i class="fas fa-align-left"></i> Mobile Menu</span> <span class="menu-close"></span>',
		meanMenuOpen: '<span class="mean-menu-text"><i class="fas fa-align-left"></i> Mobile Menu</span> <span class="menu-bar"></span>',
...
var dant =event.strftime('%D')*1;

var sat=event.strftime('%H')*1;

var min=event.strftime('%M')*1;

var sek=event.strftime('%S')*1;

if(dant==0 && sat==0 && min==0 && sek==0) {

if($(".counter-deal").length>0)
...
$(".counter-deal").hide();
	...
	$('.grid-icons button').on('click', function (e) {
        ...
        if(viewMode == 'grid three-column'){
			...
			$('.shop-product-wrap .boxic').addClass('col-lg-4').removeClass('col-lg-3');
		...
		if(viewMode == 'grid four-column'){
			...
			$('.shop-product-wrap .boxic').addClass('col-lg-3').removeClass('col-lg-4');
